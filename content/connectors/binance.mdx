...
> **Tip:** "Copying and pasting into Hummingbot" See [this page](/intro/support/#paste-items-from-clipboard-in-putty) for more instructions in our Support section.
...
<br />
<br />
<br />5 - Now you have created an API key. Please note that to trade on Binance
using Hummingbot, **Enable Trading** must be selected.
