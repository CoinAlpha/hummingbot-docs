...
![Figure 1: Order creation and adjustment flow chart](/img/xemm-flowchart-1.svg)
...
![Figure 2: Cancel order flow chart](/img/xemm-flowchart-2.svg)
...
![Figure 3: Cancel order flow chart](/img/xemm-flowchart-3.svg)
...
![Figure 4: Hedging order fills flow chart](/img/xemm-flowchart-4.svg)
