...
> Note:
    ...
    - The maximum weight assigned to any task must be 1 less than the weight set in the rate_limit to avoid a situation whereby such task would never get executed. i.e with `rate_limit(15, 1)`, the max weight any task of that instance should have should be 14.
    - The most important tasks should have lower weight than less important tasks.
