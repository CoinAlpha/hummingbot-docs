...
Exchange connectors are modules that allow Hummingbot to connect to exchange. This requires constant retrieval of live exchange/order book data and handling interactions with the exchange.
...
- Provide the main point of contact for the developer.
