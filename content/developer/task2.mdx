...
<Callout
  type="tip"
  body="In most scenarios, as seen in most other Centralized Exchanges(i.e. [Binance], [Crypto.com], [ProBit]), a simple WebSocket integration is used to listen on selected topics and retrieving messages to be processed in `Market` class."
  link={[
