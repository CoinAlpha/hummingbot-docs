---
title: "— Task 4"
description: Info on Hummingbot client
---
...
> Warning: As part of the QA process, for each tasks(Task 1 through 3) you are **required** to include the unit test cases for the code review process to begin. Refer to [Option 1: Unit Test Cases](/developers/connectors/task4/#option-1-unit-test-cases) to build your unit tests.
