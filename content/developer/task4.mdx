---
title: "Task 4 — Additional Functions & Configuration"

description: Additional Utility Functions and Optional Configurations
---
...
1. (Optional) Add members for Ethereum type connector.
