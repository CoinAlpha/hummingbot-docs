...
AscendEX (formerly BitMax) is a global digital asset financial platform founded by a group of Wall Street quantitative trading veterans in 2018, building on core value of “Efficiency, Resilience and Transparency.”
...
To use [AscendEX](https://ascendex.com/en/global-digital-asset-platform) connector, you will need to generate and provide your API key in order to trade using Hummingbot.
...
3. Now you have created an API key, connect it to Hummingbot by using the `connect ascend_ex` command.
...
### Maxiumum and Minimum Order Sizes

See [this page](https://ascendex.com/en/help-center/articles/360025991074) for the maximum and minimum order size for all trading pair.
...
By default, trading fees for this exchange charges a fee of 0.1% for makers and 0.1% for takers on large market cap assets and 0.2% maker fee and 0.2 taker fee on altcoins.
