...
To use [Beaxy](https://beaxy.com/) connector, you will need to generate and provide your API key in order to trade using Hummingbot.
...
![](/img/beaxy-api-key.png)

3. Give the API a name then click create.

![](img/beaxy-create-api.png)
