...
Users may experience websocket error and timeout may occur every 2 hours. Digifinex has a low rate limit, check out this article on the exchange's trading rule [here](https://docs.digifinex.com/en-ww/v3/#digifinex-api-trading-rules)
