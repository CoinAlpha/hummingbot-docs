...
To use [Digifinex](https://www.digifinex.com/en-ww/login) connector, you will need to generate and provide your API key in order to trade using Hummingbot.
...
<Callout
  ...
  link={[
    "https://www.google.com/search?q=how+to+enable+2FA+on+digifinex&oq=how+to+enabl&aqs=chrome.0.69i59j69i57j69i59l2j69i61l3.1434j0j4&sourceid=chrome&ie=UTF-8",
  ]}
/>

![](/img/digifinex-accounts.png)
...
<Callout
  type="note"
  bullets={[
    "Websocket error / timeout may occur every 2 hours",
    "Low rate limit, I think we need to add a link to their trade rule so that users should be aware on this limit and avoid getting ban look at link [here]",
  ]}
  link={["https://docs.digifinex.com/en-ww/v3/#digifinex-api-trading-rules"]}
/>
