...
FTX is a cryptocurrency derivatives exchange launched in 2019. One of the top crypto derivatives exchabges in the world, it allows users to trade contracts on crypto assets, or buy tokens representing other assets. Its team comes from Wall Street quant firms and tech companies.
...
Docs for the websocket API can be found [here], while those for the REST API are [here]
