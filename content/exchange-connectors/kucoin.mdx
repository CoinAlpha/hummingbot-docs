...
<Callout type="tip" body="For copying and pasting into Hummingbot, see [this page] for more instructions in our Support section." link={["/intro/support/#paste-items-from-clipboard-in-putty"]} />
