...
Below are the status of each connector as of version 0.37.1.
...
| [Eterbase](/exchange-connectors/eterbase)               |  <StatusCircle color="red" font="25px"/>   | Connector is broken and unusable. Refer to our [Github page](https://github.com/CoinAlpha/hummingbot/issues?q=is%3Aopen+%22eterbase%22+in%3Atitle) page for more information            |
