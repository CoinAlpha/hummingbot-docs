...
It is important to note that this will not always be the same exactly as the exchange's trading rules. In Hummingbot, the minimum order size is calculated as:
