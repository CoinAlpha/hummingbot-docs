...
During pure market making or cross-exchange market making strategy creation, you will be prompted with one of the following parameters for order amount:
