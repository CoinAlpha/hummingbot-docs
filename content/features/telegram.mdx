...
> **Tip:** If you are running multiple bots with Telegram enabled, you can use the same Telegram chat ID with different API tokens from each bot you created to control all of them. You can also use their [chat folders](https://telegram.org/blog/folders) feature to organize your bots. ~~ Visit the Telegram blog page for more info.~~
