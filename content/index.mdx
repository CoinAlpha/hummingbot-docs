...
<table>
  <tr>
    <td style="background-color: #AFEEEE">
      <b>
        🚧 We are currently in the process of transitioning to this new docs
        site.
        <br />
        If you are experiencing problems with search and usage, please go to our
        old docs site: <a href="https://docs-v1.hummingbot.io">
          Docs v1.0
        </a>. <br />
