...
<Callout type="warning" body="Hummingbot is experimental, open source software that is still in beta, and you use it at your own risk. Please review the [Apache 2.0 license]." link={["https://github.com/CoinAlpha/hummingbot/blob/master/LICENSE"]} />

<Callout
  type="note"
  body="[test] testting stuff like `when` tto #bold#"
  link={["www.google.com"]}
/>
