...
After installing Hummingbot from source, see [Launch Hummingbot from source](/operation-2/launch-exit) for instructions on how to start and run Hummingbot from source.
