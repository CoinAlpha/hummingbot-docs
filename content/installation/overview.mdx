...
| Platform | Binary | Docker | Source |
| ------------ | :---------------------------------------: | :---------------------------------------: | :---------------------------------------: |
| Windows | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> |
| MacOS | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> |
| Linux | - | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> |
| Raspberry Pi | - | <TableStatus color="green" font="25px" /> | <TableStatus color="green" font="25px" /> |
...
See this article for instructions on keeping Hummingbot updated: [Update/Revert Hummingbot](updating)
