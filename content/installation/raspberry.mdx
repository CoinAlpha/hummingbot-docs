...
<Callout
  ...
  bullets={[
    ...
    "Added #version-0.38.0-arm_beta#, see release notes of [v0.38.0]",
  ]}
  link={["http://discord.hummingbot.io/", "/release-notes/0.38.0/"]}
/>
...
coinalpha/hummingbot:version-0.38.0-arm_beta
```
