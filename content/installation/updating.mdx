---
title: "Updating Hummingbot"
description: How to update Hummingbot
---
...
Hummingbot is regularly updated each month (see [Release Notes](/release-notes/)) and recommend users to regularly update their installations to get the latest version of the software.  
