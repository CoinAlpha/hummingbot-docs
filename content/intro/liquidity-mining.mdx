...
> **Important information regarding campaign terms:**<br/>
...
> **Tip:** To ensure that orders do not stay outstanding for longer than 30 minutes, Hummingbot users should disable [order refresh tolerance](https://docs.hummingbot.io/strategies/advanced-mm/order-refresh-tolerance/#how-it-works).
...
> **Note:** You can use your Binance XZC deposit address and enter in the miner app to receive XZC directly into Binance.
...
> **Note:** Users will be required to enter Tron wallet address in the Hummingbot Miners app to enable USDT-TRON payments.
