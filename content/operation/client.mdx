...
> Note: To select text on macOS, you may need to enable the **Allow Mouse Reporting** option by pressing **`⌘ + R`** or selecting **View > Allow Mouse Reporting** in the menu bar.
