...
or you can use arguments `--live` to displays the orderbook of the taker market or secondary market in real time . For example, run `order_book --live --lines [value]` to specify the number of lines displayed in real time.
