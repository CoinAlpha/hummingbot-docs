...
Testing connections, please wait...
             ...
             binance_perpetual            No               No               GREEN
     binance_perpetual_testnet            No               No               GREEN
                    binance_us            No               No              YELLOW
                      bitfinex            No               No              YELLOW
                        bitmax            No               No               GREEN
                       bittrex            No               No              YELLOW
                     blocktane            No               No               GREEN
                          celo            No               No               GREEN
...
<Callout
  ...
  link={[
    "https://hummingbot.zendesk.com/hc/en-us/articles/900005194643-Delete-API-keys",
  ]}
/>
...
`Allocated` shows the assets that are currently being used.
...
Take note the reconfiguring of `inventory_target_base_pct` for DEX connectors is not working at the moment.

<Callout
  type="note"
  body="Configuring these parameters on the fly only works for the [Pure market making] and [Perpetual market making] strategy"
  link={[
...
<Callout
  type="note"
  body="This command will only work while a strategy is running."
/>

Run `order_book --lines [value]` to specify the number of lines displayed or you can use arguments `--live` to displays the order book of the market in real-time. For example, run `order_book --live`. The order book displays the top 5 bid/ask prices and volume of the current market in real-time.
...
You can use arguments `--live` to displays the order book of the market in real-time. For example, run `order_book --lines 20 --live`.
