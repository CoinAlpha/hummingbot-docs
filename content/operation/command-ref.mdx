...
<Callout type="note" body="`open_orders` only works with [binance] exchange connector." link={["https://www.binance.com/en/"]} />
...
<Callout type="note" body="`pnl` only works with [binance] exchange connector." link={["https://www.binance.com/en/"]} />
...
<Callout type="note" body="This command will only work while a strategy is running." />
