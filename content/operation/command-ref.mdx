...
>>>  history
  ...
  binance / BTC-USDT
    ...
    Trades:
                                   buy     sell     total
      Number of trades              62       65       127
      Total trade volume (BTC)  0.0496  -0.0520  -0.00240
      Total trade volume (USDT) -668.3      702     33.69
      Avg price                  13475    13501     13489

    Assets:

                          Start   Current     Change
      BTC                0.0299   0.00275   -0.00240
      USDT                199.0     232.6      33.69
      BTC-USDT price   13158.14   13646.02       487
      Base asset %        66.45%    61.77%    -4.68%

    Performance:
      Hold portfolio value           607.7 USDT
      Current portfolio value        608.7 USDT
      Trade P&L                     0.9430 USDT
      Fees paid                       0.30 USDT
      Total P&L                      0.643 USDT
      Return %:                           0.10%
```

** How It Works **

The `history` command in Hummingbot will show the current session's total past trades, inventory, duration, market trading pair performance, and return percentage.
...
Return % = (Total P&L/Current portfolio value)\*100
