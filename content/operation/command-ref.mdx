...
You can use arguments `--live` to displays the orderbook of the market in real time . For example, run `order_book --live 30 --live`.
The order book displays the top 30 bid/ask prices and volume of the current market in real time.

![orderbook-live](/img/orderbook-30lines-live.gif)
