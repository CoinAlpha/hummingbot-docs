...
### How to stop active container?

First you would need to run `docker ps -a` to get the list of containers available. Then you can try the following,
1. Locate the container id of the bot you want to stop
2. Run `docker container stop ` followed by your container id

![Docker Container Stop](/img/docker_container_stop.PNG)
