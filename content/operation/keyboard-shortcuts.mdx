...
| -------------------------------- | ------- |
| CTRL + C                         | Copy    |
| SHIFT + RMB ![rmb](/img/rmb.png) | Paste   |

To highlight, hold **SHIFT + LMB** ![lmb](/img/lmb.svg) and drag across the text you want to select.
...
Then you should be able to select text by holding **`LMB`** ![lmb](/img/lmb.svg) and drag. You can also hold down **`⌥ + shift`** to select specific lines like the image below.
