...
<Callout type="note" body="This connector has undergone code review, internal testing and was shipped during one of our most recent releases. As part of User Acceptance Testing, we encourage users to report any issues with this connector to our [Discord server] or [submit a bug report]." link={["https://discord.hummingbot.io","https://github.com/CoinAlpha/hummingbot/issues/new?assignees=&labels=bug&template=bug_report.md&title="]} />
...
<Callout type="note" body="For calculation details on the various gas level, see [DeFi Pulse Data API docs]." link={["https://docs.defipulse.com/api-docs-by-provider/egs/gas-price"]} />
