...
Check the connection of your Uniswapv3 and gateway by accessing its **global_conf.yml** with a text editor.

Access gateway **global_conf.yml** with this [documentation](/gateway/http://localhost:8000/gateway/installation/#install-gateway-via-source).

Make sure the value of the connections for uniswapv3 below are open and ended with double quotation marks (**""**) in your **global_conf.yml**
