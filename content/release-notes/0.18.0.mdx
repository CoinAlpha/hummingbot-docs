...
The connector is now available in Hummingbot and should work with existing strategies. Read more about Dolomite connector in the [User Manual](/spot-connectors/dolomite/).
...
- [Install via Binary on Windows](/installation/windows/#install-from-binary)
- [Install via Binary on macOS](/installation/mac/#install-from-binary)
