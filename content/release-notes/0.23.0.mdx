...
Read more about how to use KuCoin connector in the [User Manual](/spot-connectors/kucoin/).
...
- Added instructions on how to reset forgotten password, transferring files from/to WSL, and downloading a previous version of Hummingbot in Windows.
