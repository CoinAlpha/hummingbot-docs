...
<Callout type="note" body="`Old config files won't work` This release contains many changes to the import process, so previous strategy configuration files will not be compatible with this version." />
