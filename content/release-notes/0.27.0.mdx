...
<Callout
  type="tip"
  body="`Introducing the Hummingbot Public Roadmap` In order to communicate the status of bug fixes and planned improvements, we recently began to publish the [Hummingbot Public Roadmap]. We will keep this page updated, so please bookmark this page to see the newest updates to the Hummingbot codebase."
  link={["https://github.com/CoinAlpha/hummingbot/projects/2"]}
/>
