...
Since this feature is for advanced users, it is not configurable from the Hummingbot client. Follow the guide in our documentation how to use the [Order Override](/strategies/order-override/) feature.
...
More information in [External Pricing Source Configuration](/strategies/external-price-source/).
...
- A major update on [Task 4. Required Connector Configuration](/developer/task4/), most of these tasks are now contained within the connector package, you no longer need to update various other files in the Hummingbot.
