...
<Callout type="note" body="Bitfinex connector is currently not working with cross-exchange and arbitrage strategy." />
...
<Callout type="note" body="Currently, `inventory_target_base_pct` can only be configured when running on centralized exchange connectors." />
