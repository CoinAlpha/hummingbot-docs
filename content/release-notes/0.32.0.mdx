...
- A major update on [Task 4. Required Connector Configuration](/developer/task4/#gatsby-focus-wrapper), most of these tasks are now contained within the connector package, you no longer need to update various other files in the Hummingbot.
