...
- [#2129](https://github.com/CoinAlpha/hummingbot/issues/2129): The `history` command is redesigned with more information, see [operation/command-ref/#history] for details.
