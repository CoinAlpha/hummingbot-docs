...
In the last release, we released the [Binance Futures connector](/exchange-connectors/binance-futures/) and an experimental [perpetual market making](http://localhost:8000/strategies/perpetual-market-making/) strategy.
