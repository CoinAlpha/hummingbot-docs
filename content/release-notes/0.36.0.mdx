...
- **Install via Docker**: [Linux](/installation/linux/#install-via-docker) | [Windows](/installation/windows/#install-via-docker) | [macOS](http://installation/mac/#install-via-docker) | [Raspberry Pi](/installation/mac/#install-via-docker) | [Raspberry Pi](/installation/raspberry/)
...
Refer to the documentation [here](https://docs.hummingbot.io/exchange-connectors/loopring/#retrieving-loopring-api-keys), to update your API keys.
