...
- **Install via Docker**: [Linux](/installation/linux/#install-via-docker) | [Windows](/installation/windows/#install-via-docker) | [macOS](/installation/mac/#install-via-docker) | [Raspberry Pi](/installation/mac/#install-via-docker)
...
Refer to the documentation [here](/exchange-connectors/loopring/#retrieving-loopring-api-keys), to update your API keys.
...
This strategy also allows users to market make in more than one market pair on the specified exchange, boosting their liquidity mining rewards! We are planning to add more configurable parameters for more advanced users to customize the strategy further. Learn more about it here #2871.
