...
It contains #[3059](https://github.com/CoinAlpha/hummingbot/pull/3059) a hotfix that resolves trading pair completion not working as intended when creating a new strategy as described in GitHub issue #[3055](https://github.com/CoinAlpha/hummingbot/issues/3055).
