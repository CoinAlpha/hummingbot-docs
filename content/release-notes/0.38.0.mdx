...
- **Download Installer**: [Windows](https://dist.hummingbot.io/hummingbot_v0.38_setup.exe) | [macOS](https://dist.hummingbot.io/hummingbot_v0.38.dmg)
...
In this release, Hummingbot has added more exchanges and is planning to add a lot more exchanges this year! Hummingbot now supports [DigiFinex](https://www.digifinex.com/en-ww) connector. DigiFinex is the world's top 10 crypto exchange by trading volume and liquidity, offering spot, leverage, perpetual swap trading, and fiat to crypto trading. DigiFinex is widely loved for being stable, secure, and easy to use.
...
Read more about how to use the DigiFinex connector [here](/exchange-connectors/digifinex/).
...
Read more about how to use the HitBTC connector [here](/exchange-connectors/hitbtc/).

## New Exchange Connector CoinZoom

[CoinZoom](https://www.coinzoom.com/) is an institutional-grade digital currency trading platform that uses the team’s vast experience in providing superb trade quality and customer-focused tools and technology to help our customers to become successful digital currency traders. CoinZoom will offer services in Buying, Selling, and Trading Bitcoin, Ripple, Ethereum, and other top digital currency pairs. Our decades of experience in financial technology security are equally important in safeguarding customer funds and customers’ digital currency positions.
...
Read more about how to use the CoinZoom connector [here](/exchange-connectors/coinzoom/).
...
Learn more about it [here](/exchange-connectors/ascend-ex/)
...
If enabled, when the trading pair symbols mismatch, the bot will use a real-time conversion rate from the oracle. For example, if markets are set to trade for LINK-USDT and LINK-USDC, the bot will use the oracle conversion rate between USDT and USDC.
...
- [#3011](https://github.com/CoinAlpha/hummingbot/pull/3011) When using `inventory_cost`, bot will prompt for the `inventory_price` as well
