...
## New Strategy Feature : `hanging_orders`

To activate this advanced feature, users must configure their saved Avellaneda Strategy Config File.

Enable `hanging_orders = false` with `hanging_orders = true`.

You can also set your Aggregation Type in the computation of your hanging orders.
