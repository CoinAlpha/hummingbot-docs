...
![status command](/img/status-command.png)
...
- [Wallet import/export](/operation/keys-wallets-nodes/#setup-ethereum-wallet): how to import and export Ethereum wallets

## 🐞 Bug fixes and miscellaneous updates

We fixed several bugs in this release. Thanks to 🙏 all the bug reporters who took part in our bug bounty program!
...
- Fixed a bug in which the bug prints excessive `Maker order size must be greater than 0` log messages ([bug bounty recipient](https://github.com/CoinAlpha/hummingbot/issues/118))
