...
See [Building Connectors](/developers/tutorial.md) for details.
...
This release is a hotfix to version 0.28.0
...
For more information, see the [celo-arb strategy page](/strategies/celo-arb)
...
This feature should help users create more custom bots and manage exchange rate limits better. See [Order Refresh Tolerance](/strategies/order-refresh-tolerance/) for more information.
...
This feature should help users express a view that the market will stay range-bound. See [Price Band](/strategies/price-band/) for more information.
...
This release is a hotfix to version 0.26.0
...
> Note "Old config files won't work": This release contains many changes to the import process, so previous strategy configuration files will not be compatible with this version.
...
Now you can use the revamped [config](/operation/command-ref) command to adjust spreads without stopping the bot. We plan to extend this functionality to other parameters such as order amount in the future.
...
> Tip "Updating from source" :Due to the updated Python version, users who install Hummingbot from source need to run `./uninstall` and `./clean` before updating.
...
This release is a hotfix to version 0.24.0
...
More information about [Basic Mode](https://docs.hummingbot.io/strategies/pure-market-making/) and [Advanced Mode](https://docs.hummingbot.io/strategies/adv-market-making) of Pure Market Making in our User Manual.
...
Read through [Logs and Logging](https://docs.hummingbot.io/advanced/operation/adv-command-ref) section of our Utilities page for more information.
...
You may read through [External Pricing Source Configuration](https://docs.hummingbot.io/strategies/price-source/) in the user manual for more information.
