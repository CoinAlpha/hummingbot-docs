...
> **Algorand requires you to specifically enable assets, e.g. USDT, in order for your wallet to be able to receive that asset. Please enable USDT for your wallet in order to be able to receive USDT ASA rewards.** The feature on the Algorand blockchain is intended to prevent random token spamming.
...
> **Tip:** You can swap USDT ASA to USDT ETH/Tron/Omni which are all supported by Binance, you can check this [app](https://swaptether.io/) to swap between different implementations of tether. 
