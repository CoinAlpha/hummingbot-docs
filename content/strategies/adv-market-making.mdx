...
| [Filled Order Delay](./filled-order-delay)                  | Set the duration of how long to wait before placing the next set of orders in the case at least one of your orders gets filled. |
| [Hanging Orders](./hanging-orders)                          | If enabled, the orders on the opposite side to the filled orders remain active.                                                 |
...
| [Order Refresh Tolerance](./order-refresh-tolerance)        | Set the spread (from mid-price) to defer the order refresh process to the next cycle.                                           |
| [Price Band](./price-band)                                  | Place only sell orders when mid-price goes above this price.                                                                    |
| [Ping Pong](./ping-pong)                                    | Set the buy and sell orders to be placed alternately.                                                                           |
...
| [Max Order Age](/strategies/max-order-age/)                 | Set the duration of the maximum age of an order and it will be refreshed depending on the value set.                            |
