...
- see [Setup Infura Node](https://docs.hummingbot.io/operation/keys-wallets-nodes/). Take note of the Ethereum RPC URL to be used later for Gateway Docker settings.
