...
Refer to [Docker](https://docs.hummingbot.io/installation/linux/) for details. Before you start using Hummingbot, read through the follwing sections to have an understanding of how Hummingbot works:
...
The following sections describes the installation and configuration process for Balancer.
...
## AMM Balancer Arbitrage Strategy
