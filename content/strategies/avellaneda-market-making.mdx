---
title: Avellaneda Market Making (BETA)
...
In expert mode, the user will need to define directly the basic parameters of the algorithm described in the [foundation paper](https://people.orie.cornell.edu/sfs33/LimitOrderBook.pdf), and no recalculation of parameters will happen.
