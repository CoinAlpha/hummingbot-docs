...
> **Tip:** Ultra-light sync mode — The `celo-arb` strategy works with Celo node running in "ultra-light" mode, which is much faster to sync. See our [Quickstart](https://hummingbot.io/academy/celo-arb/) for instructions on how to start a node in ultra-light mode.
...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">Enter your secondary exchange name</font>
</div>
...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">What is the amount of [base_asset] per order?</font>
</div>
...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">
    How much buffer do you want to add to the Celo price to account for slippage
    (Enter 1 for 1%)?
  </font>
</div>
