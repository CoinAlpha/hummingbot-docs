...
![Figure 1: Hummingbot acts as market maker on maker exchange](xemm-1.png)
...
![Figure 2: Hummingbot fills an order on the maker exchanges and hedges on the taker exchange](xemm-2.png)
