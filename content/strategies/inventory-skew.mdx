...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">Would you like to enable inventory skew? (Yes/No)</font>
</div>
...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">
    On [exchange], you have [base_asset_balance] and [quote_asset_balance]. By
    market value, your current inventory split is [base_%_ratio] and
    [quote_%_ratio]. Would you like to keep this ratio?
  </font>
</div>
...
<div style={{ padding: "10px 20px", backgroundColor: "#1c1c1c" }}>
  <font color="#20a26a">
    What is your tolerable range of inventory around the target, expressed in
    multiples of your total order size?
  </font>
</div>
