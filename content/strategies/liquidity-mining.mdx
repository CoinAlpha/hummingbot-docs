...
This table displays the market, mid price, best bid, best ask, and volatility. Under the market it shows the markets chosen to join liquidity mining. The mid price is the average of the best bid and best ask price in the orderbook. The best bid and best ask shown above are the current best bid and best ask in the orderbook. The adjustment in volatility will apply to your current spread at `order_refresh_time` if the value of the volatility is higher than your current spread.
