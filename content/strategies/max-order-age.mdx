...
This parameter allows you to set the maximum age of the orders. When an order exceeds this age, it refreshes with the price and amount depending on the market's movement. The parameter cannot be set to 0 or a negative value.
