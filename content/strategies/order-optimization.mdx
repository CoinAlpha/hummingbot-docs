...
Users can now use order optimizaton with multiple `order_levels` see the example below. Order optimization is triggered and it placed the 2nd order which has a spread of 0.2% because of `order_level_spread`.
