...
description: Info on order overide
---
...
User provides orders to directly override the orders placed by order_amount and order_level parameter.
...
1. Edit the strategy config file located in the Hummingbot `conf` folder using a text editor. <br/>See [Where are my config and log files?](/intro/support/#where-are-my-config-and-log-files) in the FAQ page for more information.
