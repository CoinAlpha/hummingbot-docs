...
1. Edit the strategy config file located in the Hummingbot `conf` folder using a text editor. <br/>See [Where are my config and log files?](/faq/#where-are-my-config-and-log-files) in the FAQ page for more information.
