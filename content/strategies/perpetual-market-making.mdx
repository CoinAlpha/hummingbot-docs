...
<Callout
  type="tip"
  body="Users can test how this strategy works without risking real funds by connecting their Binance Futures Testnet account to Hummingbot. We also recommend to run the bot side-by-side with the exchange to help understand the strategy."
/>
