...
`Would you like to use an external pricing source for mid-market price? (Yes/No)`
...
`Do you want to let your maker orders match and fill if they cross the order book?`
