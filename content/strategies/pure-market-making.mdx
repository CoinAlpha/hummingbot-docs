...
<Prompt prompt="Enter your maker exchange name" response=">>> binance" />
...
<Prompt
  prompt="At what distance/spread from the mid price do you want the orders to be cancelled?"
  response=">>> 2"
/>
