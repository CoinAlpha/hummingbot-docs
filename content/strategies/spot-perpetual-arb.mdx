...
With the position open, the bot will scan the prices on both connectors, and once the price spread between them reach a value below `min_convergence`, the bot will close both positions.
