...
![image](https://user-images.githubusercontent.com/123457728/219840239-83a198df-2f71-48dc-8eff-617b59ca46f8.png)
Click Enter:
Once completed, add Conda to path as shown in the command below:
$export PATH=/home/mbcjaguar/miniconda3/bin:$PATH

NOTE: Replace the user(mbcjaguar) path to miniconda3 as specified during the installation.
