const sidebarCategories = {
  ...
  Connectors: [
    ...
    "connectors/dolomite",             
    "connectors/hummingbot-supported-connector",
    "connectors/community-supported-connector"],
  Strategies: ["strategies/overview", "strategies/pure-market-making"],
  ConnectorsDeveloperGuide: ["strategies/overview", "strategies/pure-market-making"],
  Strategies_Developer_Guide: [],
  Developer_Guide: [],
  Resources: [
    "resources/faq",
    "resources/glossary",
